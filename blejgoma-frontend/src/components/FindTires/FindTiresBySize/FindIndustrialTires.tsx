...
import "./FindIndustrialTires.scss";

export const FindIndustrialTires = () => {
  const {
    tireFilters,
    handleChange,
    findCarTires,
    ...
    loading,
    error,
  } = useFindTiresBySize("industriale");

  return (
    <div className="FindIndustrialTires">
      <Select
        disabled={loading}
        value={widthOptions
      ...
      <Button
        disabled={loading}
        className="FindIndustrialTires__button"
        label="Kërko goma"
