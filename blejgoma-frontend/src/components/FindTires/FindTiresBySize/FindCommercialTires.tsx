...
import "./FindCommercialTires.scss";

export const FindCommercialTires = () => {
  const {
    tireFilters,
    handleChange,
    findCarTires,
    ...
    loading,
    error,
  } = useFindTiresBySize("komerciale");

  return (
    <div className="FindCommercialTires">
      <Select
        disabled={loading}
        value={widthOptions
      ...
      <Button
        disabled={loading}
        className="FindCommercialTires__button"
        label="Kërko goma"
